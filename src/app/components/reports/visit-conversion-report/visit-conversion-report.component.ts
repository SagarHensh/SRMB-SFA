...
import { VISIT_CONVERSION_REPORT_LIST } from 'src/app/TableHeader';

@Component({
  selector: 'app-visit-conversion-report',
  templateUrl: './visit-conversion-report.component.html',
  styleUrls: ['./visit-conversion-report.component.css']
})
export class VisitConversionReportComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.tableHeader = VISIT_CONVERSION_REPORT_LIST;
  ...
  getReport() {
    ...
    this.common.getVisitConversionReport(req).subscribe((res: any) => {
  ...
  onDownload() {
    ...
    this.common.getVisitConversionReportDownload(req).subscribe(response => {
