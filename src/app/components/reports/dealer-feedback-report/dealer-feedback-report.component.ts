...
import { DEALER_FEEDBACK_REPORT_LIST } from 'src/app/TableHeader';

@Component({
  selector: 'app-dealer-feedback-report',
  templateUrl: './dealer-feedback-report.component.html',
  styleUrls: ['./dealer-feedback-report.component.css']
})
export class DealerFeedbackReportComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.tableHeader = DEALER_FEEDBACK_REPORT_LIST;
  ...
  getReport() {
    ...
    this.common.getDealerFeedbackReport(req).subscribe((res: any) => {
  ...
  onDownload() {
    ...
    this.common.getDealerFeedbackReportDownload(req).subscribe(response => {
