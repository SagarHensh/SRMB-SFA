...
@Component({
  selector: 'app-enquiry-visit-report',
  templateUrl: './enquiry-visit-report.component.html',
  styleUrls: ['./enquiry-visit-report.component.css']
})
export class EnquiryVisitReportComponent implements OnInit {
  ...
  getVisitReports() {
    ...
    this.common.getEnquiryVisitReports(req).subscribe(res => {
