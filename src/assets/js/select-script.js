  ...
  $.fn.select3 = function (options) {
    ...
    $(selectorID)
      ...
      .each(function (index, element) {
        if (element.text != "" && element.value != "") {
          //console.log(element.text, this.value);
          dataItems.push({
    ...
    var buildELement = $(
      '<div class="searchSelect3" id="' +
        idDiv +
        '" style="position:relative;"><input class="searchSelect3_Input" placeholder="' +
        opts.placeholder +
        '" value="' +
        opts.defaultvalue +
        '" id="' +
        idInput +
        '"><span class="fa fa-times searchSelect3_Times" id="' +
        idClose +
    ...
    var showList = function (query, valuee) {
      ...
      if (drew == false) {
        ...
        $(selectorList).on("click", "li", function () {
          ...
          $(selectorID).val($(this).find("label").attr("data-val"));
          $(selectorList).empty();
          $(selectorClose).show();
          $(selectorList).css("z-index", -1);
          $(selectorID).change();
...
$(document).ready(function (e) {
  $("#selectZone1").select3({ placeholder: " Zone", zIndex: 100 });

  $("#selectEmployeeType2").select3({
    placeholder: " Employee Type",
    zIndex: 100,
  });
  $("#selectEmployeeName").select3({ placeholder: " Employee Name", zIndex: 100 });
  $("#selectStateName2").select3({ placeholder: " State", zIndex: 100 });
  $("#selectDistrictName2").select3({ placeholder: " District", zIndex: 100 });
  $("#selectZone2").select3({ placeholder: " Zone", zIndex: 100 });

  $("#selectEmployeeType3").select3({
    placeholder: " Employee Type",
    zIndex: 100,
  });
  $("#selectStateName3").select3({ placeholder: " State", zIndex: 100 });
  $("#selectDistrictName3").select3({ placeholder: " District", zIndex: 100 });
  $("#selectZone3").select3({ placeholder: " Zone", zIndex: 100 });

  $("#selectEmployeeType4").select3({
    placeholder: " Employee Type",
    zIndex: 100,
  });
  $("#selectStateName4").select3({ placeholder: " State", zIndex: 100 });
  $("#selectDistrictName4").select3({ placeholder: " District", zIndex: 100 });
  $("#selectZone4").select3({ placeholder: " Zone", zIndex: 100 });

  $("#selectEmployeeType5").select3({
    placeholder: " Employee Type",
    zIndex: 100,
  });
  $("#selectStateName5").select3({ placeholder: " State", zIndex: 100 });
  $("#selectDistrictName5").select3({ placeholder: " District", zIndex: 100 });
  $("#selectZone5").select3({ placeholder: " Zone", zIndex: 100 });

  $("#selectStateName6").select3({ placeholder: " State", zIndex: 100 });
  $("#selectDistrictName6").select3({ placeholder: " District", zIndex: 100 });
  $("#selectZone6").select3({ placeholder: " Zone", zIndex: 100 });


  $("#selectLeadName").select3({ placeholder: " Lead Name", zIndex: 100 });
  $("#selectLeadName1").select3({ placeholder: " Lead Name", zIndex: 100 });
  $("#selectLeadName2").select3({ placeholder: " Lead Name", zIndex: 100 });
  $("#selectLeadName3").select3({ placeholder: " Lead Name", zIndex: 100 });
  $("#selectOpturnityName").select3({
